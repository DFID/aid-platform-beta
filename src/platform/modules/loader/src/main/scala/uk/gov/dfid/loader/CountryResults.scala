...
class CountryResults(engine: ExecutionEngine, db: DefaultDB, auditor: Auditor) {
  ...
  def loadCountryResults = {
    ...
    val country_results_src = Source.fromURL("https://raw.githubusercontent.com/DFID/aid-platform-beta/38cea7ad9330516cba779de8801b8c15767bf175/src/platform/modules/loader/src/main/resources/country_results.csv");
